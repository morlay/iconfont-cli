...
var argv = _yargs2['default'].usage('Usage: $0 <svgfiles> --outDir <output> [options]').example('iconfont *.svg -o dist').options({
  outDir: {
...
}).help('help').alias('help', 'h').showHelpOnFail(false, 'whoops, something went wrong! run with --help').argv;

(0, _index2['default'])(argv._, argv);